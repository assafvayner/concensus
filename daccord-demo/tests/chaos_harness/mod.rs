...
use daccord_demo::ConsensusServiceClient;
use daccord_demo::{GetDecisionsRequest, HealthRequest, ProposeRequest};
...
impl DockerCluster {
    pub fn up_3node_raft() -> Self {
        ...
        Self {
            nodes: vec![
                NodeAddr {
                    container: "daccord-demo-node-1-1".into(),
                    grpc: "localhost:50051".into(),
                },
                NodeAddr {
                    container: "daccord-demo-node-2-1".into(),
                    grpc: String::new(),
                },
                NodeAddr {
                    container: "daccord-demo-node-3-1".into(),
                    grpc: String::new(),
                },
            ],
            composed: true,
